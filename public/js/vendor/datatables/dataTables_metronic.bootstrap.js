...
$.extend($.fn.dataTableExt.oStdClasses, {
    ...
    "sLengthSelect": "form-control input-small input-inline"
});
...
$.extend($.fn.dataTableExt.oPagination, {
    "bootstrap_extended": {
        "fnInit": function (oSettings, nPaging, fnDraw) {
            ...
            $(nPaging).append(
                '<div class="pagination-panel"> ' + oLang.pageOf + '  ' +
                '<a href="#" class="btn btn-sm default prev disabled" title="' + oLang.previous + '"><i class="fa fa-angle-left"></i></a>' +
                '<input type="text" class="pagination-panel-input form-control input-mini input-inline input-small" maxlenght="5" style="text-align:center; margin: 0 5px;">' +
                '<a href="#" class="btn btn-sm default next disabled" title="' + oLang.next + '"><i class="fa fa-angle-right"></i></a> ' +
                oLang.page + '  ' + oLang.total + '  ' +' <span class="pagination-panel-total"></span>' + oLang.page +
                '</div>'
            );
